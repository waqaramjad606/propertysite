...
<?php 
  ...
  $query1 = mysqli_query($conn, "SELECT * FROM property where is_active=1");
  $totalapartments = mysqli_num_rows($query1);  

  // $query2 = mysqli_query($con, "SELECT * FROM users where status='PENDING'");
  // $totalpending = mysqli_num_rows($query2);

  // $query3 = mysqli_query($con, "SELECT * FROM users where status='APPROVED'");
  // $totalactive = mysqli_num_rows($query3);

  // $query4 = mysqli_query($con, "SELECT * FROM users where status='BLOCKED'");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Active Properties</h1>
          </div>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Active Properties List</div>
    ...
    display: none;
          ...
          <div class="card shadow mb-4" id="allordersdiv">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">All Active Properties</h6>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="padding: 1px;">
                        ...
                        <?php if($allapartments['is_active']=="1") {?>
                          <button class=" btn btn-danger mybtn" name="" id="<?php echo $allapartments['id']; ?>" onclick="disableproperty(this.id);" >Disable</button>
                        <?php } ?>
                    ...
                    success:function(data){
                      if(data.trim()=="deleted"){
                        swal("Deleted!","Apartment Deleted!","success").then((value) => {
                            window.location.href = "allactiveproperties";
                          });
